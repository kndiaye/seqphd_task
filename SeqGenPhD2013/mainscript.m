...
addpath(cwdpath);
%taskdescriptor; % for pre-op/MEG ??
%taskdescriptor_perop; % for per-op recordings
taskdescriptor_LFP_Park0;
...
dev    = nan(experiment.NSampleXp, 1);
stddev = nan(experiment.NSampleXp, 1);
prop   = nan(experiment.NSampleXp, 1);
...
parfor i=1:experiment.NSampleXp
   ...
   % if mod(i, 10000)==0; fprintf('%d samples ... \n', i); end
end
